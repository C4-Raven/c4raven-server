...
from raven.forms.package_form import PackageForm
...
class Packages(db.Model):
    ...
    def from_wtform(self, form: PackageForm):
        ...
        apk = APK(os.path.join(app.config.get("RAVEN_DATA_FOLDER"), "packages", self.file_name))
        ...
        self.file_size = (
            Path(os.path.join(app.config.get("RAVEN_DATA_FOLDER"), "packages", self.file_name))
            .stat()
            .st_size
        )
